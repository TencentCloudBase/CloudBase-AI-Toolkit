...
Configure permissions for each collection in the [CloudBase Platform](https://tcb.tencentcloud.com/dev) collection management page.
...
**Configuration Entry:**
Configure security rules in the [CloudBase Platform/Database](https://tcb.tencentcloud.com/dev#/db/doc/model) collection management page.
