...
本方案优化 `miniprogram-development` skill，使其从“CloudBase 偏置的小程序 skill”调整为“通用微信小程序开发 skill + CloudBase 子场景 + 调试/预览双路径”。主 `SKILL.md` 聚焦通用触发条件、边界、行为规则与路由；CloudBase 集成与调试/预览细节拆入独立 references。
