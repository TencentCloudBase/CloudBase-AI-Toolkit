...
### 支持哪些 AI 开发工具？
支持 CloudBase AI CLI、OpenClaw、Cursor、WindSurf、WorkBuddy、ZCode、Codex App、CodeBuddy、CLINE、GitHub Copilot、Claude Code、Kimi Code / Kimi Work、Gemini CLI、Codex CLI、OpenCode、Trae、通义灵码、RooCode、文心快码、Augment Code、Qwen Code、iFlow CLI 等主流 AI 开发工具。
