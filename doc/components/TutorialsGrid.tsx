...
const tutorials: Tutorial[] = [
  ...
  // 视频
  {
    id: 'video-cloudbase-resume-miniprogram',
    title: '用 CodeBuddy+CloudBase，轻松开发个性化简历小程序',
    description: '全栈若城',
    category: '视频教程',
    url: 'https://www.bilibili.com/video/BV1588zzcEXW/',
    type: 'video',
    thumbnail: 'https://7463-tcb-advanced-a656fc-1257967285.tcb.qcloud.la/video-thumbnails/BV1588zzcEXW.jpg',
    terminalTags: ['小程序'],
    appTypeTags: ['工具/效率'],
    devToolTags: ['CodeBuddy'],
  },
  {
    id: 'video-cloudbase-mcp-ai-class',
    title: '云开发CloudBase：MCP+AI小课堂',
    description: '腾讯云云开发',
    category: '视频教程',
    url: 'https://www.bilibili.com/video/BV1iyJBzvEoc/',
    type: 'video',
    thumbnail: 'https://7463-tcb-advanced-a656fc-1257967285.tcb.qcloud.la/video-thumbnails/BV1iyJBzvEoc.jpg',
    terminalTags: ['Web'],
    appTypeTags: ['教育/学习'],
    devToolTags: ['CodeBuddy'],
  },
  {
    id: 'video-cloudbase-agent-ui',
    title: '云开发CloudBase：Agent UI组件',
    description: '腾讯云云开发',
    category: '视频教程',
    url: 'https://www.bilibili.com/video/BV1Br9yYwE5o/',
    type: 'video',
    thumbnail: 'https://7463-tcb-advanced-a656fc-1257967285.tcb.qcloud.la/video-thumbnails/BV1Br9yYwE5o.jpg',
    terminalTags: ['Web', '小程序'],
    appTypeTags: ['工具/效率'],
    devToolTags: ['CodeBuddy'],
  },
  {
    id: 'video-cloudbase-sdk',
    title: '云开发CloudBase：SDK',
    description: '腾讯云云开发',
    category: '视频教程',
    url: 'https://www.bilibili.com/video/BV1ozRAYLEPy/',
    type: 'video',
    thumbnail: 'https://7463-tcb-advanced-a656fc-1257967285.tcb.qcloud.la/video-thumbnails/BV1ozRAYLEPy.jpg',
    terminalTags: ['Web', '小程序'],
    appTypeTags: ['工具/效率'],
    devToolTags: ['CodeBuddy'],
  },
