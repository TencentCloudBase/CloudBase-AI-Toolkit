...
<ParameterTable
  parameters={[
    ...
    },
    {
      name: "apiName",
      type: "string",
      description: `mode=openapi 时指定。API 名称。 可填写的值: "cloudrun", "functions", "mysqldb", "ai_model", "nosql", "storage", "auth"`,
    },
    {
      name: "action",
      type: "string",
