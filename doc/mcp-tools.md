...
<ParameterTable
  parameters={[
    ...
    },
    {
      name: "sql",
      type: "string",
      description: `action=execute、dryRun、planMigration 或 applyMigration 使用的 SQL 语句`,
    },
    {
      name: "confirm",
      type: "boolean",
    ...
    },
    {
      name: "objectName",
      type: "string",
      description: `action=migrationDetail 或 rollbackMigration 时使用的 migration ID。`,
    }
  ]}
/>
...
特别说明：
- rules 模板会自动包含当前 mcp 版本号信息（版本号：2.21.1-beta.2），便于后续维护和版本追踪
