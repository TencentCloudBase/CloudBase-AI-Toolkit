  ...
  parameters={[
    {
      ...
      type: "string",
      required: true,
      description: `写操作类型，例如 createFunction、updateFunctionCode、invokeFunction、deleteFunction、createFunctionTrigger（定时任务 / cron / timer）、deleteFunctionTrigger、attachLayer、detachLayer 可填写的值: "createFunction", "updateFunctionCode", "updateFunctionConfig", "invokeFunction", "deleteFunction", "createFunctionTrigger", "deleteFunctionTrigger", "createLayerVersion", "deleteLayerVersion", "attachLayer", "detachLayer", "updateFunctionLayers", "incrementalDeployFunction"`,
    },
    {
      name: "func",
      type: "object",
...
特别说明：
- rules 模板会自动包含当前 mcp 版本号信息（版本号：2.21.1-beta.0），便于后续维护和版本追踪
