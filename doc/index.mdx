...
CloudBase 支持多种接入方式。你可以选择[一键安装插件](/ai/cloudbase-ai-toolkit/ai-agent-plugins)（支持 Codex、Claude Code、WorkBuddy 等 AI 编程助手），也可以[手动配置 MCP 连接](/ai/cloudbase-ai-toolkit/getting-started)。以下涵盖了所有主流 AI IDE 和工具的配置方式。
