...
- Treating a grayed-out 云开发 button as a DevTools bug — trial/test accounts do not support CloudBase; confirm a registered mini program account first (see [CloudBase integration reference](https://cnb.cool/tencent/cloud/cloudbase/CloudBase-AI-Toolkit/-/git/raw/main/config/source/skills/miniprogram-development/references/cloudbase-integration.md), section 环境开通).
...
- [Common Pitfalls](https://cnb.cool/tencent/cloud/cloudbase/CloudBase-AI-Toolkit/-/git/raw/main/config/source/skills/miniprogram-development/references/pitfalls.md) — read before generating code for optional chaining, TDesign styling, Canvas + storage, and environment issues
````
