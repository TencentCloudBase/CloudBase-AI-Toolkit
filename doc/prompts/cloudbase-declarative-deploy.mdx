...
用 cloudbaserc 配置描述整个项目的目标状态，通过 deployPlan 预演和 deployApply 应用，支持多环境覆盖与只部署部分资源
...
- "帮我把 CloudBase 项目改成 cloudbaserc 声明式部署配置"
- "部署前先给我一份 deployPlan 预演结果，确认后再应用"
- "用 cloudbaserc 的 envOverrides 配置多环境部署"

import AIDevelopmentPrompt from '../components/AIDevelopmentPrompt';

<AIDevelopmentPrompt ruleId="cloudbase-declarative-deploy" />
...
```bash
npx skills add https://github.com/tencentcloudbase/skills --skill cloudbase-declarative-deploy
```

当前 Skill 在线查看： [cloudbase-declarative-deploy](https://skills.sh/tencentcloudbase/skills/cloudbase-declarative-deploy)
...
- [config-schema.md](https://cnb.cool/tencent/cloud/cloudbase/CloudBase-AI-Toolkit/-/git/raw/main/config/source/skills/cloudbase-declarative-deploy/references/config-schema.md)
- [plan-and-apply.md](https://cnb.cool/tencent/cloud/cloudbase/CloudBase-AI-Toolkit/-/git/raw/main/config/source/skills/cloudbase-declarative-deploy/references/plan-and-apply.md)
- [multi-env.md](https://cnb.cool/tencent/cloud/cloudbase/CloudBase-AI-Toolkit/-/git/raw/main/config/source/skills/cloudbase-declarative-deploy/references/multi-env.md)
````
...
- [`references/config-schema.md`](https://cnb.cool/tencent/cloud/cloudbase/CloudBase-AI-Toolkit/-/blob/main/config/source/skills/cloudbase-declarative-deploy/references/config-schema.md)
- [`references/multi-env.md`](https://cnb.cool/tencent/cloud/cloudbase/CloudBase-AI-Toolkit/-/blob/main/config/source/skills/cloudbase-declarative-deploy/references/multi-env.md)
- [`references/plan-and-apply.md`](https://cnb.cool/tencent/cloud/cloudbase/CloudBase-AI-Toolkit/-/blob/main/config/source/skills/cloudbase-declarative-deploy/references/plan-and-apply.md)
