...
使用 CloudBase PostgreSQL（PG 模式）设计表结构、通过 JS SDK 或 MCP 工具读写数据、配置权限，并落地 Web 后台管理场景
...
- "帮我在 CloudBase PostgreSQL 中设计用户表并配置权限"
- "在 Web 应用中使用 CloudBase PostgreSQL 的 JS SDK 实现数据增删改查"
- "帮我排查 CloudBase PG 应用的数据库连接和权限配置问题"

import AIDevelopmentPrompt from '../components/AIDevelopmentPrompt';

<AIDevelopmentPrompt ruleId="postgresql-development-cloudbase" />
...
```bash
npx skills add https://github.com/tencentcloudbase/skills --skill postgresql-development-cloudbase
```

当前 Skill 在线查看： [postgresql-development-cloudbase](https://skills.sh/tencentcloudbase/skills/postgresql-development-cloudbase)
...
- [index.md](https://cnb.cool/tencent/cloud/cloudbase/CloudBase-AI-Toolkit/-/git/raw/main/config/source/skills/postgresql-development-cloudbase/references/index.md)
- [pg-mode-overview.md](https://cnb.cool/tencent/cloud/cloudbase/CloudBase-AI-Toolkit/-/git/raw/main/config/source/skills/postgresql-development-cloudbase/references/pg-mode-overview.md)
- [auth-and-rls.md](https://cnb.cool/tencent/cloud/cloudbase/CloudBase-AI-Toolkit/-/git/raw/main/config/source/skills/postgresql-development-cloudbase/references/auth-and-rls.md)
- [app-workflow.md](https://cnb.cool/tencent/cloud/cloudbase/CloudBase-AI-Toolkit/-/git/raw/main/config/source/skills/postgresql-development-cloudbase/references/app-workflow.md)
- [storage-pg.md](https://cnb.cool/tencent/cloud/cloudbase/CloudBase-AI-Toolkit/-/git/raw/main/config/source/skills/postgresql-development-cloudbase/references/storage-pg.md)
- [http-api.md](https://cnb.cool/tencent/cloud/cloudbase/CloudBase-AI-Toolkit/-/git/raw/main/config/source/skills/postgresql-development-cloudbase/references/http-api.md)
- [rls-patterns.md](https://cnb.cool/tencent/cloud/cloudbase/CloudBase-AI-Toolkit/-/git/raw/main/config/source/skills/postgresql-development-cloudbase/references/rls-patterns.md)
- [troubleshooting.md](https://cnb.cool/tencent/cloud/cloudbase/CloudBase-AI-Toolkit/-/git/raw/main/config/source/skills/postgresql-development-cloudbase/references/troubleshooting.md)
````
...
- [`references/app-workflow.md`](https://cnb.cool/tencent/cloud/cloudbase/CloudBase-AI-Toolkit/-/blob/main/config/source/skills/postgresql-development-cloudbase/references/app-workflow.md)
- [`references/auth-and-rls.md`](https://cnb.cool/tencent/cloud/cloudbase/CloudBase-AI-Toolkit/-/blob/main/config/source/skills/postgresql-development-cloudbase/references/auth-and-rls.md)
- [`references/http-api.md`](https://cnb.cool/tencent/cloud/cloudbase/CloudBase-AI-Toolkit/-/blob/main/config/source/skills/postgresql-development-cloudbase/references/http-api.md)
- [`references/index.md`](https://cnb.cool/tencent/cloud/cloudbase/CloudBase-AI-Toolkit/-/blob/main/config/source/skills/postgresql-development-cloudbase/references/index.md)
- [`references/pg-mode-overview.md`](https://cnb.cool/tencent/cloud/cloudbase/CloudBase-AI-Toolkit/-/blob/main/config/source/skills/postgresql-development-cloudbase/references/pg-mode-overview.md)
- [`references/rls-patterns.md`](https://cnb.cool/tencent/cloud/cloudbase/CloudBase-AI-Toolkit/-/blob/main/config/source/skills/postgresql-development-cloudbase/references/rls-patterns.md)
- [`references/storage-pg.md`](https://cnb.cool/tencent/cloud/cloudbase/CloudBase-AI-Toolkit/-/blob/main/config/source/skills/postgresql-development-cloudbase/references/storage-pg.md)
- [`references/troubleshooting.md`](https://cnb.cool/tencent/cloud/cloudbase/CloudBase-AI-Toolkit/-/blob/main/config/source/skills/postgresql-development-cloudbase/references/troubleshooting.md)
