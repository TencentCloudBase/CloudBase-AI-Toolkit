...
- Read [UI Design Activation Checklist](https://cnb.cool/tencent/cloud/cloudbase/CloudBase-AI-Toolkit/-/git/raw/main/config/source/skills/ui-design/checklist.md) before interface generation.
...
- [`checklist.md`](https://cnb.cool/tencent/cloud/cloudbase/CloudBase-AI-Toolkit/-/blob/main/config/source/skills/ui-design/checklist.md)
