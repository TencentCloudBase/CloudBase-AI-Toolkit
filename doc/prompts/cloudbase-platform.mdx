...
- [protocols/change-safety-protocol.md](https://cnb.cool/tencent/cloud/cloudbase/CloudBase-AI-Toolkit/-/git/raw/main/config/source/skills/cloudbase-platform/references/protocols/change-safety-protocol.md)
- [protocols/deployment-gate.md](https://cnb.cool/tencent/cloud/cloudbase/CloudBase-AI-Toolkit/-/git/raw/main/config/source/skills/cloudbase-platform/references/protocols/deployment-gate.md)
- [protocols/deployment-share.md](https://cnb.cool/tencent/cloud/cloudbase/CloudBase-AI-Toolkit/-/git/raw/main/config/source/skills/cloudbase-platform/references/protocols/deployment-share.md)
- [protocols/sensitive-runtime-data-protection.md](https://cnb.cool/tencent/cloud/cloudbase/CloudBase-AI-Toolkit/-/git/raw/main/config/source/skills/cloudbase-platform/references/protocols/sensitive-runtime-data-protection.md)
````
...
- [`references/protocols/change-safety-protocol.md`](https://cnb.cool/tencent/cloud/cloudbase/CloudBase-AI-Toolkit/-/blob/main/config/source/skills/cloudbase-platform/references/protocols/change-safety-protocol.md)
- [`references/protocols/deployment-gate.md`](https://cnb.cool/tencent/cloud/cloudbase/CloudBase-AI-Toolkit/-/blob/main/config/source/skills/cloudbase-platform/references/protocols/deployment-gate.md)
- [`references/protocols/deployment-share.md`](https://cnb.cool/tencent/cloud/cloudbase/CloudBase-AI-Toolkit/-/blob/main/config/source/skills/cloudbase-platform/references/protocols/deployment-share.md)
- [`references/protocols/sensitive-runtime-data-protection.md`](https://cnb.cool/tencent/cloud/cloudbase/CloudBase-AI-Toolkit/-/blob/main/config/source/skills/cloudbase-platform/references/protocols/sensitive-runtime-data-protection.md)
