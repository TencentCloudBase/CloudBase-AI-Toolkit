...
对 CloudBase 环境做健康检查、日志诊断、告警解读与故障排查，覆盖限频 429、云函数 404、调用量为 0 等典型问题
...
- "帮我巡检一下 CloudBase 环境的健康状况"
- "云函数调用量突然变成 0 了，帮我排查原因"
- "帮我解读 CPU 使用率告警并给出处理建议"

import AIDevelopmentPrompt from '../components/AIDevelopmentPrompt';

<AIDevelopmentPrompt ruleId="ops-inspector" />
...
当前 Skill 在线查看： [ops-inspector](https://skills.sh/tencentcloudbase/skills/ops-inspector)
...
- [`references/alarm-interpretation.md`](https://cnb.cool/tencent/cloud/cloudbase/CloudBase-AI-Toolkit/-/blob/main/config/source/skills/ops-inspector/references/alarm-interpretation.md)
- [`references/fault-playbooks.md`](https://cnb.cool/tencent/cloud/cloudbase/CloudBase-AI-Toolkit/-/blob/main/config/source/skills/ops-inspector/references/fault-playbooks.md)
