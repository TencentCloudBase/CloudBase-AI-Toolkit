...
- Read [Cloud Functions Execution Checklist](https://cnb.cool/tencent/cloud/cloudbase/CloudBase-AI-Toolkit/-/git/raw/main/config/source/skills/cloud-functions/checklist.md) before deployment or runtime changes.
- Decide whether the task is Event Function, HTTP Function, or actually CloudRun.
- Pick the detailed reference file in [references.md](https://cnb.cool/tencent/cloud/cloudbase/CloudBase-AI-Toolkit/-/git/raw/main/config/source/skills/cloud-functions/references.md) before writing implementation code.
...
- [event-functions.md](https://cnb.cool/tencent/cloud/cloudbase/CloudBase-AI-Toolkit/-/git/raw/main/config/source/skills/cloud-functions/references/event-functions.md)
- [http-function-credentials.md](https://cnb.cool/tencent/cloud/cloudbase/CloudBase-AI-Toolkit/-/git/raw/main/config/source/skills/cloud-functions/references/http-function-credentials.md)
- [http-functions-custom-image.md](https://cnb.cool/tencent/cloud/cloudbase/CloudBase-AI-Toolkit/-/git/raw/main/config/source/skills/cloud-functions/references/http-functions-custom-image.md)
- [http-functions.md](https://cnb.cool/tencent/cloud/cloudbase/CloudBase-AI-Toolkit/-/git/raw/main/config/source/skills/cloud-functions/references/http-functions.md)
- [operations-and-config.md](https://cnb.cool/tencent/cloud/cloudbase/CloudBase-AI-Toolkit/-/git/raw/main/config/source/skills/cloud-functions/references/operations-and-config.md)
- [vpc-and-tcp-database.md](https://cnb.cool/tencent/cloud/cloudbase/CloudBase-AI-Toolkit/-/git/raw/main/config/source/skills/cloud-functions/references/vpc-and-tcp-database.md)
````
...
- [`checklist.md`](https://cnb.cool/tencent/cloud/cloudbase/CloudBase-AI-Toolkit/-/blob/main/config/source/skills/cloud-functions/checklist.md)
- [`references.md`](https://cnb.cool/tencent/cloud/cloudbase/CloudBase-AI-Toolkit/-/blob/main/config/source/skills/cloud-functions/references.md)
- [`references/event-functions.md`](https://cnb.cool/tencent/cloud/cloudbase/CloudBase-AI-Toolkit/-/blob/main/config/source/skills/cloud-functions/references/event-functions.md)
- [`references/http-function-credentials.md`](https://cnb.cool/tencent/cloud/cloudbase/CloudBase-AI-Toolkit/-/blob/main/config/source/skills/cloud-functions/references/http-function-credentials.md)
- [`references/http-functions-custom-image.md`](https://cnb.cool/tencent/cloud/cloudbase/CloudBase-AI-Toolkit/-/blob/main/config/source/skills/cloud-functions/references/http-functions-custom-image.md)
- [`references/http-functions.md`](https://cnb.cool/tencent/cloud/cloudbase/CloudBase-AI-Toolkit/-/blob/main/config/source/skills/cloud-functions/references/http-functions.md)
- [`references/operations-and-config.md`](https://cnb.cool/tencent/cloud/cloudbase/CloudBase-AI-Toolkit/-/blob/main/config/source/skills/cloud-functions/references/operations-and-config.md)
- [`references/vpc-and-tcp-database.md`](https://cnb.cool/tencent/cloud/cloudbase/CloudBase-AI-Toolkit/-/blob/main/config/source/skills/cloud-functions/references/vpc-and-tcp-database.md)
