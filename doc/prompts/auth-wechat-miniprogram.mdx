...
For detailed scenarios, examples, and patterns, read [extended-guide.md](https://cnb.cool/tencent/cloud/cloudbase/CloudBase-AI-Toolkit/-/git/raw/main/config/source/skills/auth-wechat-miniprogram/references/extended-guide.md).

## Reference index

All packaged reference files (required for skill lint reachability):

- [extended-guide.md](https://cnb.cool/tencent/cloud/cloudbase/CloudBase-AI-Toolkit/-/git/raw/main/config/source/skills/auth-wechat-miniprogram/references/extended-guide.md)
````
...
- [`references/extended-guide.md`](https://cnb.cool/tencent/cloud/cloudbase/CloudBase-AI-Toolkit/-/blob/main/config/source/skills/auth-wechat-miniprogram/references/extended-guide.md)
