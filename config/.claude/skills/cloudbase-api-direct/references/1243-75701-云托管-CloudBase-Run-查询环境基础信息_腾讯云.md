...
[点击调试](https://console.cloud.tencent.com/api/explorer?Product=tcbr&Version=2022-02-17&Action=DescribeEnvBaseInfo)
...
| 参数名称 | 必选 | 类型 | 描述 |
| --- | --- | --- | --- |
| Action | 是 | String | [公共参数](/document/api/1243/75716) ，本接口取值：DescribeEnvBaseInfo。 |
...
| 参数名称 | 类型 | 描述 |
| --- | --- | --- |
| EnvBaseInfo | [EnvBaseInfo](/document/api/1243/75713#EnvBaseInfo) | 
环境基础信息
