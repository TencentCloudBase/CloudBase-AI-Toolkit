...
[点击调试](https://console.cloud.tencent.com/api/explorer?Product=tcbr&Version=2022-02-17&Action=StopVersionInstance)
...
| 参数名称 | 必选 | 类型 | 描述 |
| --- | --- | --- | --- |
| Action | 是 | String | [公共参数](/document/api/1243/75716) ，本接口取值：StopVersionInstance。 |
...
X-TC-Action: StopVersionInstance
<公共请求参数>

{
    "EnvId": "env-sdsdf",
    "ServerName": "test-fisher-manual",
    "InstanceName": "test-fisher-manual-003-sddf"
}
```
