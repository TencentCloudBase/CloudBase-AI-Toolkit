...
[点击调试](https://console.cloud.tencent.com/api/explorer?Product=tcbr&Version=2022-02-17&Action=DescribeCloudRunPodList)
...
| 参数名称 | 必选 | 类型 | 描述 |
| --- | --- | --- | --- |
| Action | 是 | String | [公共参数](/document/api/1243/75716) ，本接口取值：DescribeCloudRunPodList。 |
...
示例值：version-example |
| PageSize | 否 | Integer | 默认为10， 最大为50  
不传或传0时 取默认10  
大于50时取50  
示例值：1 |
| PageNum | 否 | Integer | 不传或传0时 会默认为1  
示例值：15 |
...
| 参数名称 | 类型 | 描述 |
| --- | --- | --- |
| PodList | Array of [VersionPodInstance](/document/api/1243/75713#VersionPodInstance) | pod实例列表  
示例值：\[ { "Webshell": "", "PodId": "sdfsdf", "Status": "running", "CreateTime": "2025-07-25 19:00:00" } \] |
| TotalCount | Integer | pod总数  
示例值：10 |
...
X-TC-Action: DescribeCloudRunPodList
<公共请求参数>
