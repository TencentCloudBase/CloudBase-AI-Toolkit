...
[点击调试](https://console.cloud.tencent.com/api/explorer?Product=tcbr&Version=2022-02-17&Action=OperateServerManage)
...
| 参数名称 | 必选 | 类型 | 描述 |
| --- | --- | --- | --- |
| Action | 是 | String | [公共参数](/document/api/1243/75716) ，本接口取值：OperateServerManage。 |
...
示例值：server-nginx |
| TaskId | 是 | Integer | 任报Id  
示例值：1000 |
| OperateType | 是 | String | 操作类型:cancel | go\_back | done  
示例值：cancel |
