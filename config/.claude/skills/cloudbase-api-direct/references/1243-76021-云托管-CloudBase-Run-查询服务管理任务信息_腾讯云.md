...
[点击调试](https://console.cloud.tencent.com/api/explorer?Product=tcbr&Version=2022-02-17&Action=DescribeServerManageTask)
...
| 参数名称 | 必选 | 类型 | 描述 |
| --- | --- | --- | --- |
| Action | 是 | String | [公共参数](/document/api/1243/75716) ，本接口取值：DescribeServerManageTask。 |
...
示例值：true |
| Task | [ServerManageTaskInfo](/document/api/1243/75713#ServerManageTaskInfo) | 任务信息 |
