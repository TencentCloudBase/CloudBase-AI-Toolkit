...
| 参数名称 | 必选 | 类型 | 描述 |
|---------|---------|---------|---------|
| Action | 是 | String | [公共参数](/document/product/705/16277?!preview&preview_docmenu=1&lang=cn&!document=1)，本接口取值：DescribeRestoreTables。 |
...
| InstanceId | 是 | String | 实例ID<br/>示例值：tnt-123 |
| Time | 是 | String | 回档时间 （2019-12-09 23:00:12）<br/>示例值：2000-01-02 03:04:05 |
| Filters.N | 否 | Array of String | 过滤器 |

## 3. 输出参数

| 参数名称 | 类型 | 描述 |
|---------|---------|---------|
| Tables | Array of String | 可回档表格<br/>示例值：["table1","table2"]|
...
```
https://tcb.tencentcloudapi.com/?Action=DescribeRestoreTables
