...
[点击调试](https://console.cloud.tencent.com/api/explorer?Product=cynosdb&Version=2019-01-07&Action=ModifyAccountPrivileges)
...
| 参数名称 | 必选 | 类型 | 描述 |
| --- | --- | --- | --- |
| Action | 是 | String | [公共参数](/document/api/1003/48100) ，本接口取值：ModifyAccountPrivileges。 |
...
示例值：cynosdbmysql-asd12qwe |
| Account | 是 | [InputAccount](/document/api/1003/48097#InputAccount) | 账号信息  
示例值：{"AccountName": "andy","Host": "%"} |
| GlobalPrivileges.N | 否 | Array of String | 全局权限数组  
示例值：\["CREATE","DELETE"\] |
| DatabasePrivileges.N | 否 | Array of [DatabasePrivileges](/document/api/1003/48097#DatabasePrivileges) | 数据库权限数组  
示例值：\["ALTER", "ALTER ROUTINE"\] |
| TablePrivileges.N | 否 | Array of [TablePrivileges](/document/api/1003/48097#TablePrivileges) | 表权限数组  
示例值：\["DROP", "GRANT OPTION"\] |
