...
[点击调试](https://console.cloud.tencent.com/api/explorer?Product=tcb&Version=2018-06-08&Action=RollbackPGUserMigrations)
...
| 参数名称 | 必选 | 类型 | 描述 |
| --- | --- | --- | --- |
| Action | 是 | String | [公共参数](/document/api/876/34812) ，本接口取值：RollbackPGUserMigrations。 |
...
示例值：task-d9fd1d51 |
| RolledBack | Array of [MigrationSummary](/document/api/876/34822#MigrationSummary) | 

已成功回滚并删除 history 的 migration

 |
| SkippedRollbackSql | Array of [MigrationSummary](/document/api/876/34822#MigrationSummary) | 

未提供 Rollback SQL、视为成功并删除 history 的 migration

 |
| Failed | [MigrationSummary](/document/api/876/34822#MigrationSummary) | 
...
X-TC-Action: RollbackPGUserMigrations
<公共请求参数>
