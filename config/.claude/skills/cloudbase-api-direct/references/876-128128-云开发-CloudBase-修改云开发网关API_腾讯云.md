...
[点击调试](https://console.cloud.tencent.com/api/explorer?Product=tcb&Version=2018-06-08&Action=ModifyCloudBaseGWAPI)
...
| 参数名称 | 必选 | 类型 | 描述 |
| --- | --- | --- | --- |
| Action | 是 | String | [公共参数](/document/api/876/34812) ，本接口取值：ModifyCloudBaseGWAPI。 |
...
示例值：envId |
| APIId | 是 | String | API ID  
示例值：xxxxxx-xxxxxx-xxxxxx-xxxxxx |
| Options.N | 是 | Array of [CloudBaseOption](/document/api/876/34822#CloudBaseOption) | 选项列表，key取值：domain, path。 |
...
X-TC-Action: ModifyCloudBaseGWAPI
<公共请求参数>
