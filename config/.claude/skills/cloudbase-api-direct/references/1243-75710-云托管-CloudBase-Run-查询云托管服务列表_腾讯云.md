...
[点击调试](https://console.cloud.tencent.com/api/explorer?Product=tcbr&Version=2022-02-17&Action=DescribeCloudRunServers)
...
| 参数名称 | 必选 | 类型 | 描述 |
| --- | --- | --- | --- |
| Action | 是 | String | [公共参数](/document/api/1243/75716) ，本接口取值：DescribeCloudRunServers。 |
| Version | 是 | String | [公共参数](/document/api/1243/75716) ，本接口取值：2022-02-17。 |
| Region | 否 | String | [公共参数](/document/api/1243/75716) ，本接口不需要传递此参数。 |
| EnvId | 是 | String | 环境Id  
示例值：env-example |
| PageSize | 否 | Integer | 默认为9， 最大为30  
不传或传0时 取默认9  
大于30时取30  
示例值：15 |
| PageNum | 否 | Integer | 不传或传0时 会默认为1  
示例值：1 |
| ServerName | 否 | String | 服务名  
示例值：server-name |
| ServerType | 否 | String | 服务类型：function | container  
示例值：function |
...
| 参数名称 | 类型 | 描述 |
| --- | --- | --- |
| ServerList | Array of [ServerBaseInfo](/document/api/1243/75713#ServerBaseInfo) | 服务列表 |
| Total | Integer | 服务总数  
示例值：10 |
