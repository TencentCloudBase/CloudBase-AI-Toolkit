...
[点击调试](https://console.cloud.tencent.com/api/explorer?Product=tcbr&Version=2022-02-17&Action=ReleaseGray)
...
| 参数名称 | 必选 | 类型 | 描述 |
| --- | --- | --- | --- |
| Action | 是 | String | [公共参数](/document/api/1243/75716) ，本接口取值：ReleaseGray。 |
...
示例值：test-server |
| GrayType | 是 | String | 灰度类型  
示例值：gray |
| TrafficType | 是 | String | 流量类型  
示例值：HEADERS |
| VersionFlowItems.N | 否 | Array of [VersionFlowInfo](/document/api/1243/75713#VersionFlowInfo) | 流量策略 |
| OperatorRemark | 否 | String | 操作标识  
示例值：remark |
| GrayFlowRatio | 否 | Integer | 流量比例  
示例值：100 |
