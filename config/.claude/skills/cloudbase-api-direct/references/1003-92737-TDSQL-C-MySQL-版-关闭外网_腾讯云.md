...
[点击调试](https://console.cloud.tencent.com/api/explorer?Product=cynosdb&Version=2019-01-07&Action=CloseWan)
...
| 参数名称 | 必选 | 类型 | 描述 |
| --- | --- | --- | --- |
| Action | 是 | String | [公共参数](/document/api/1003/48100) ，本接口取值：CloseWan。 |
...
| InstanceGroupId | 否 | String | 实例组id  
示例值：cynosdbmysql-grp-o48ssqs5 |
| InstanceId | 否 | String | 实例id  
示例值：cynosdbmysql-ins-qvni5o11 |
...
```
https://cynosdb.tencentcloudapi.com/?Action=CloseWan
...
| FailedOperation.GetNetServiceInfoError | 查询接入组网络信息失败。 |
