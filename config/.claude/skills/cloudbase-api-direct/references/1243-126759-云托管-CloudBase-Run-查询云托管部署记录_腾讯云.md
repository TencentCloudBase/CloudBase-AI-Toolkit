...
[点击调试](https://console.cloud.tencent.com/api/explorer?Product=tcbr&Version=2022-02-17&Action=DescribeCloudRunDeployRecord)
...
| 参数名称 | 必选 | 类型 | 描述 |
| --- | --- | --- | --- |
| Action | 是 | String | [公共参数](/document/api/1243/75716) ，本接口取值：DescribeCloudRunDeployRecord。 |
...
| 参数名称 | 类型 | 描述 |
| --- | --- | --- |
| DeployRecords | Array of [DeployRecord](/document/api/1243/75713#DeployRecord) | 部署列表 |
...
X-TC-Action: DescribeCloudRunDeployRecord
<公共请求参数>
...
### 示例2 DescribeCloudRunDeployRecord
