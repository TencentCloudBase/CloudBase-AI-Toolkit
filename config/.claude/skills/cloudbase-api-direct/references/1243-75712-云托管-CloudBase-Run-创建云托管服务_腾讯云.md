...
[点击调试](https://console.cloud.tencent.com/api/explorer?Product=tcbr&Version=2022-02-17&Action=CreateCloudRunServer)
...
| 参数名称 | 必选 | 类型 | 描述 |
| --- | --- | --- | --- |
| Action | 是 | String | [公共参数](/document/api/1243/75716) ，本接口取值：CreateCloudRunServer。 |
...
示例值：serverName |
| DeployInfo | 是 | [DeployParam](/document/api/1243/75713#DeployParam) | 

部署信息

 |
| ServerConfig | 否 | [ServerBaseConfig](/document/api/1243/75713#ServerBaseConfig) | 

服务配置信息(已废弃)

 |
| Items.N | 否 | Array of [DiffConfigItem](/document/api/1243/75713#DiffConfigItem) | 

服务配置信息

 |
| VpcInfo | 否 | [CreateVpcInfo](/document/api/1243/75713#CreateVpcInfo) | 
...

{
    ...
    "DeployInfo": {
        "DeployType": "package",
        "PackageName": "express.zip",
        "PackageVersion": "1766482739"
    },
    "EnvId": "lowcode-9g2o448axxxxx",
    "Items": [
        {
