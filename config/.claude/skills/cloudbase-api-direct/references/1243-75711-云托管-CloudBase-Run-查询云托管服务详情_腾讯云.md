...
[点击调试](https://console.cloud.tencent.com/api/explorer?Product=tcbr&Version=2022-02-17&Action=DescribeCloudRunServerDetail)
...
| 参数名称 | 必选 | 类型 | 描述 |
| --- | --- | --- | --- |
| Action | 是 | String | [公共参数](/document/api/1243/75716) ，本接口取值：DescribeCloudRunServerDetail。 |
...
| 参数名称 | 类型 | 描述 |
| --- | --- | --- |
| BaseInfo | [ServerBaseInfo](/document/api/1243/75713#ServerBaseInfo) | 服务基本信息 |
| ServerConfig | [ServerBaseConfig](/document/api/1243/75713#ServerBaseConfig) | 服务配置信息 |
| OnlineVersionInfos | Array of [OnlineVersionInfo](/document/api/1243/75713#OnlineVersionInfo) | 在线版本信息 |
| RequestId | String | 唯一请求 ID，由服务端生成，每次请求都会返回（若请求因其他原因未能抵达服务端，则该次请求不会获得 RequestId）。定位问题时需要提供该次请求的 RequestId。 |

## 4\. 示例

### 示例1 DescribeCloudRunServerDetail
