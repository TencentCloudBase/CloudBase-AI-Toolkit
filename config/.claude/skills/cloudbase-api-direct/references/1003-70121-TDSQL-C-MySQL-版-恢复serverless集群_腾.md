...
[点击调试](https://console.cloud.tencent.com/api/explorer?Product=cynosdb&Version=2019-01-07&Action=ResumeServerless)
...
| 参数名称 | 必选 | 类型 | 描述 |
| --- | --- | --- | --- |
| Action | 是 | String | [公共参数](/document/api/1003/48100) ，本接口取值：ResumeServerless。 |
...
示例值：cynosdbmysql-xxxx |

## 3\. 输出参数

| 参数名称 | 类型 | 描述 |
| --- | --- | --- |
| FlowId | Integer | 异步流程ID  
示例值：1008306 |
...
| InvalidParameterValue.ClusterNotFound | 未查询到集群。 |
| InvalidParameterValue.DbModeNotServerlessError | 集群类型必须为serverless。 |
