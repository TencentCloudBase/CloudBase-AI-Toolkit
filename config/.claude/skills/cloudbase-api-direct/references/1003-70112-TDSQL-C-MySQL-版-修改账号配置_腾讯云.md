...
[点击调试](https://console.cloud.tencent.com/api/explorer?Product=cynosdb&Version=2019-01-07&Action=ModifyAccountParams)
...
| 参数名称 | 必选 | 类型 | 描述 |
| --- | --- | --- | --- |
| Action | 是 | String | [公共参数](/document/api/1003/48100) ，本接口取值：ModifyAccountParams。 |
...
| ClusterId | 是 | String | 集群id，不超过32个字符  
示例值：cynosdbmysql-asd123qw |
| Account | 是 | [InputAccount](/document/api/1003/48097#InputAccount) | 账号信息  
示例值：{"AccountName": "andy","Host": "%"} |
| AccountParams.N | 是 | Array of [AccountParam](/document/api/1003/48097#AccountParam) | 数据库表权限数组,当前仅支持参数：max\_user\_connections，max\_user\_connections不能大于10240  
示例值：\[{"ParamName":"max\_user\_connections","ParamValue":"400"}\] |
...
| InvalidParameter.InvalidParameterError | 未知参数，请检查参数是否有效。 |
