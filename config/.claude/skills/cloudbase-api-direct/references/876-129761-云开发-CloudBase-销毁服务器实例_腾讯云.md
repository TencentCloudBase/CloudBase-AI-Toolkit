...
[点击调试](https://console.cloud.tencent.com/api/explorer?Product=tcb&Version=2018-06-08&Action=DeleteVmInstance)
...
| 参数名称 | 必选 | 类型 | 描述 |
| --- | --- | --- | --- |
| Action | 是 | String | [公共参数](/document/api/876/34812) ，本接口取值：DeleteVmInstance。 |
| Version | 是 | String | [公共参数](/document/api/876/34812) ，本接口取值：2018-06-08。 |
| Region | 否 | String | [公共参数](/document/api/876/34812) ，本接口不需要传递此参数。 |
| InstanceId | 是 | String | 服务器实例id  
示例值：lhins-4amyetqm |
| EnvId | 是 | String | 环境id  
示例值：reinstate-3gle1iv1f6e5c582 |
...
X-TC-Action: DeleteVmInstance
<公共请求参数>

{
    "InstanceId": "lhins-4amyetqm",
    "EnvId": "reinstate-3gle1iv1f6e5c582"
}
```
...
{
    "Response": {
        "RequestId": "29aa6dd0-d8f9-479a-8e65-8c2c7ae48b54"
    }
}
```
