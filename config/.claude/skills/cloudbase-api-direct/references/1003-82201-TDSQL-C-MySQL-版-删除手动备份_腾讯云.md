...
[点击调试](https://console.cloud.tencent.com/api/explorer?Product=cynosdb&Version=2019-01-07&Action=DeleteBackup)
...
| 参数名称 | 必选 | 类型 | 描述 |
| --- | --- | --- | --- |
| Action | 是 | String | [公共参数](/document/api/1003/48100) ，本接口取值：DeleteBackup。 |
...
| SnapshotIdList.N | 否 | Array of Integer | 备份文件ID，旧版本使用的字段，不推荐使用  
示例值：\["4928\\r\\n"\] |
| BackupIds.N | 否 | Array of Integer | 备份文件ID，推荐使用  
示例值：\["1000\\r\\n"\] |
...
```
https://cynosdb.tencentcloudapi.com/?Action=DeleteBackup
&ClusterId=cynosdbpg-45knmnra
&SnapshotIdList.0=4928
&<公共请求参数>
```
