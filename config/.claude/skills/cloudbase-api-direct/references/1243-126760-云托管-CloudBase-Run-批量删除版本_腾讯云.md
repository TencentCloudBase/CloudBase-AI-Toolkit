...
[点击调试](https://console.cloud.tencent.com/api/explorer?Product=tcbr&Version=2022-02-17&Action=DeleteCloudRunVersions)
...
| 参数名称 | 必选 | 类型 | 描述 |
| --- | --- | --- | --- |
| Action | 是 | String | [公共参数](/document/api/1243/75716) ，本接口取值：DeleteCloudRunVersions。 |
...
| IsDeleteServer | 是 | Boolean | 是否删除服务，只有最后一个版本的时候才生效  
示例值：false |
| IsDeleteImage | 是 | Boolean | 只有删除服务的时候，才生效  
示例值：false |
| SimpleVersions.N | 是 | Array of [SimpleVersion](/document/api/1243/75713#SimpleVersion) | 删除版本的信息 |
| OperatorRemark | 否 | String | 操作备注 |

## 3\. 输出参数

| 参数名称 | 类型 | 描述 |
| --- | --- | --- |
| Result | String | succ | fail | partial  
示例值：succ |
| FailVersions | Array of [FailDeleteVersions](/document/api/1243/75713#FailDeleteVersions) | 删除失败的版本列表 |
| SuccessVersions | Array of [SuccessDeleteVersions](/document/api/1243/75713#SuccessDeleteVersions) | 删除成功的版本列表 |
...
X-TC-Action: DeleteCloudRunVersions
<公共请求参数>
