...
[点击调试](https://console.cloud.tencent.com/api/explorer?Product=tcb&Version=2018-06-08&Action=DescribeVmInstances)
...
| 参数名称 | 必选 | 类型 | 描述 |
| --- | --- | --- | --- |
| Action | 是 | String | [公共参数](/document/api/876/34812) ，本接口取值：DescribeVmInstances。 |
| Version | 是 | String | [公共参数](/document/api/876/34812) ，本接口取值：2018-06-08。 |
| Region | 否 | String | [公共参数](/document/api/876/34812) ，本接口不需要传递此参数。 |
| EnvId | 是 | String | 环境ID  
示例值：test-lighthouse-3gb1eshz5a3811de |
| Type | 是 | String | 服务器类型： LightHouse = 轻量云服务器 CVM = 云服务器  
示例值：LightHouse |
...
| 参数名称 | 类型 | 描述 |
| --- | --- | --- |
| InstanceList | Array of [VmInstance](/document/api/876/34822#VmInstance) | 主机实例列表 |
...
X-TC-Action: DescribeVmInstances
<公共请求参数>
