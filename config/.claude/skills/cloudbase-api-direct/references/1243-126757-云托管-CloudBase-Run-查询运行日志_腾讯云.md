...
[点击调试](https://console.cloud.tencent.com/api/explorer?Product=tcbr&Version=2022-02-17&Action=DescribeCloudRunProcessLog)
...
| 参数名称 | 必选 | 类型 | 描述 |
| --- | --- | --- | --- |
| Action | 是 | String | [公共参数](/document/api/1243/75716) ，本接口取值：DescribeCloudRunProcessLog。 |
...
| RunId | 是 | String | 操作 Id |

## 3\. 输出参数

| 参数名称 | 类型 | 描述 |
| --- | --- | --- |
| Logs | Array of String | 运行日志列表 |
...
X-TC-Action: DescribeCloudRunProcessLog
<公共请求参数>
