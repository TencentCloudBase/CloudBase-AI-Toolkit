...
[点击调试](https://console.cloud.tencent.com/api/explorer?Product=cynosdb&Version=2019-01-07&Action=DescribeClusterDatabases)
...
| 参数名称 | 必选 | 类型 | 描述 |
| --- | --- | --- | --- |
| Action | 是 | String | [公共参数](/document/api/1003/48100) ，本接口取值：DescribeClusterDatabases。 |
...
| Offset | Integer | 分页偏移  
示例值：1 |
| Databases | Array of String | 数据库列表  
示例值：\["database\_1","database\_2"\] |
| Limit | Integer | 分页限制数  
示例值：20 |
