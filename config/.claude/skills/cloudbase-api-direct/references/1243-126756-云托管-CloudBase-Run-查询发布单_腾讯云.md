...
[点击调试](https://console.cloud.tencent.com/api/explorer?Product=tcbr&Version=2022-02-17&Action=DescribeReleaseOrder)
...
| 参数名称 | 必选 | 类型 | 描述 |
| --- | --- | --- | --- |
| Action | 是 | String | [公共参数](/document/api/1243/75716) ，本接口取值：DescribeReleaseOrder。 |
...
示例值：false |
| ReleaseOrderInfo | [ReleaseOrderInfo](/document/api/1243/75713#ReleaseOrderInfo) | 发布单信息 |
| LastReleasedSuccessTime | String | 上一次成功发布时间  
...
X-TC-Action: DescribeReleaseOrder
<公共请求参数>
