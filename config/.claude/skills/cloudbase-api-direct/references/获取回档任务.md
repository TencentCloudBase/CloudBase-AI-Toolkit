...
| 参数名称 | 必选 | 类型 | 描述 |
|---------|---------|---------|---------|
| Action | 是 | String | [公共参数](/document/product/705/16277?!preview&preview_docmenu=1&lang=cn&!document=1)，本接口取值：DescribeRestoreTask。 |
...
| InstanceId | 是 | String | 需要获取回档任务的实例ID<br/>示例值：tnt-xxx |

## 3. 输出参数

| 参数名称 | 类型 | 描述 |
|---------|---------|---------|
| Tasks | Array of [RestoreTask](/document/product/705/16289?!preview&preview_docmenu=1&lang=cn&!document=1#RestoreTask) | 该实例回档任务|
...
```
https://tcb.tencentcloudapi.com/?Action=DescribeRestoreTask
&InstanceId=tnt-1k5i04nzo
&<公共请求参数>
```
        ...
        "Tasks": [
            {
                "Tables": [
                    {
                        "NewTableName": "coll_restore",
                        "OldTableName": "coll"
                    }
                ],
                "CreateTime": "2019-11-01 09:00:00",
                "EndTime": "2019-12-01 09:00:00",
                "Status": 1,
                "RestoreTime": "2019-12-01 09:00:00",
