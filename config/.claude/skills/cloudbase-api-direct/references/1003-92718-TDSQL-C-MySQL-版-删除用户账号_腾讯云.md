...
示例值：cynosdbmysql-ixgbd0di |
| Accounts.N | 否 | Array of [InputAccount](/document/api/1003/48097#InputAccount) | 账号数组，包含account和host |
...
```
https://cynosdb.tencentcloudapi.com/?Action=DeleteAccounts
