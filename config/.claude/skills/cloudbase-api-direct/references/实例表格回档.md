...
| 参数名称 | 必选 | 类型 | 描述 |
|---------|---------|---------|---------|
| Action | 是 | String | [公共参数](/document/product/705/16277?!preview&preview_docmenu=1&lang=cn&!document=1)，本接口取值：RestoreTCBTables。 |
...
| Time | 是 | String | 回档时间 |
| ModifyTableNamesInfo.N | 是 | Array of [ModifyTableNamesInfo](/document/product/705/16289?!preview&preview_docmenu=1&lang=cn&!document=1#ModifyTableNamesInfo) | 回档表格信息 |

## 3. 输出参数

| 参数名称 | 类型 | 描述 |
|---------|---------|---------|
| FlowId | Integer | 流程ID<br/>示例值：1|
...
```
https://tcb.tencentcloudapi.com/?Action=RestoreTCBTables
&InstanceId=tnt-5esdj6jcu
&Time=2019-10-11 09:09:09
&ModifyTableNamesInfo.0.OldTableName=test
&ModifyTableNamesInfo.0.NewTableName=test_bak
&<公共请求参数>
```
...
|---------|---------|
| InternalError | 内部错误。 |
| InternalError.InstanceStatusError | InternalError.InstanceStatusError |
| InvalidParameter | 参数错误。 |
| InvalidParameter.UnableRestoreTable | InvalidParameter.UnableRestoreTable |
| InvalidParameterValue | 参数取值错误。 |
| InvalidParameterValue.StatusAbnormal | InvalidParameterValue.StatusAbnormal |
