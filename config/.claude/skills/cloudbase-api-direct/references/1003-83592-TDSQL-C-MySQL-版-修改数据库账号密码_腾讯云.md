...
[点击调试](https://console.cloud.tencent.com/api/explorer?Product=cynosdb&Version=2019-01-07&Action=ResetAccountPassword)
...
| 参数名称 | 必选 | 类型 | 描述 |
| --- | --- | --- | --- |
| Action | 是 | String | [公共参数](/document/api/1003/48100) ，本接口取值：ResetAccountPassword。 |
...
| AccountName | 是 | String | 数据库账号名  
示例值：root |
| AccountPassword | 是 | String | 数据库账号新密码  
示例值：abc@2018 |
| ClusterId | 是 | String | 集群ID  
示例值：cynosdbpg-on5xw0ni |
| Host | 否 | String | 主机，不填默认为"%"  
示例值：% |
...
```
https://cynosdb.tencentcloudapi.com/?Action=ResetAccountPassword
...
| InvalidParameterValue.InvalidPasswordValueError | 密码不合规。 |
