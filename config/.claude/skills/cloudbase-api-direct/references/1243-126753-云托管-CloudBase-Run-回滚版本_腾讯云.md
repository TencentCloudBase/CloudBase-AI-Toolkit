...
[点击调试](https://console.cloud.tencent.com/api/explorer?Product=tcbr&Version=2022-02-17&Action=SubmitServerRollback)
...
| 参数名称 | 必选 | 类型 | 描述 |
| --- | --- | --- | --- |
| Action | 是 | String | [公共参数](/document/api/1243/75716) ，本接口取值：SubmitServerRollback。 |
...
示例值：test |
| CurrentVersionName | 是 | String | 当前版本  
示例值：server-001 |
| RollbackVersionName | 是 | String | 回滚版本  
示例值：server-002 |
...
X-TC-Action: SubmitServerRollback
<公共请求参数>
