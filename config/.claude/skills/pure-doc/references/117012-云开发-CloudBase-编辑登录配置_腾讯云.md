...
[点击调试](https://console.cloud.tencent.com/api/explorer?Product=tcb&Version=2018-06-08&Action=EditAuthConfig)
...
| 参数名称 | 必选 | 类型 | 描述 |
| --- | --- | --- | --- |
| Action | 是 | String | [公共参数](/document/api/876/34812) ，本接口取值：EditAuthConfig。 |
...
| EnvId | 是 | String | 环境id  
示例值：lowcode-xxx |
| PhoneNumberLogin | 否 | String | 手机号登录配置 "TRUE", "FALSE", "LOGIN\_ONLY"  
示例值："TRUE" |
| AnonymousLogin | 否 | String | 匿名登录配置 "TRUE", "FALSE"  
示例值："TRUE" |
| UsernameLogin | 否 | String | 用户名密码登录配置 "TRUE", "FALSE"  
示例值："TRUE" |
