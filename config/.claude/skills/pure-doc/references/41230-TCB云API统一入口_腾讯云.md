...
[文档中心](/document/product "文档中心") _\>_ API 中心

## TCB云API统一入口

最近更新时间：2026-02-27 02:03:11
...
[点击调试](https://console.cloud.tencent.com/api/explorer?Product=tcb&Version=2018-06-08&Action=CommonServiceAPI)
...
| 参数名称 | 必选 | 类型 | 描述 |
| --- | --- | --- | --- |
| Action | 是 | String | [公共参数](/document/api/876/34812) ，本接口取值：CommonServiceAPI。 |
| Version | 是 | String | [公共参数](/document/api/876/34812) ，本接口取值：2018-06-08。 |
| Region | 否 | String | [公共参数](/document/api/876/34812) ，本接口不需要传递此参数。 |
| Service | 是 | String | Service名，需要转发访问的接口名  
示例值：ModifyEnv |
| JSONData | 否 | String | 需要转发的云API参数，要转成JSON格式  
示例值：{"WxAppId":"wx989d74faaeb9fbdc","EnvType":"baas"} |
| ApiRole | 否 | String | 指定角色  
示例值：d |
...
| 参数名称 | 类型 | 描述 |
| --- | --- | --- |
| JSONResp | String | json格式response  
示例值：d |
